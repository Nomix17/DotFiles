...
hi Visual         guifg=#000000 guibg=#161e26 gui=NONE
hi CursorLine     guifg=NONE guibg=#0a0c11 gui=NONE
hi CursorLineNr   guifg=#3c4b68 guibg=#040507 gui=NONE
hi CursorColumn   guifg=NONE guibg=#040507 gui=NONE
hi ColorColumn    guifg=NONE guibg=#040507 gui=NONE
hi LineNr         guifg=#171c27 guibg=#040507 gui=NONE
hi VertSplit      guifg=#171c27 guibg=#171c27 gui=NONE
hi MatchParen     guifg=#52708b guibg=NONE gui=underline
hi StatusLine     guifg=#ffffff guibg=#040507 gui=bold
hi StatusLineNC   guifg=#ffffff guibg=#040507 gui=NONE
hi Pmenu          guifg=#ffffff guibg=#040507 gui=NONE
...
hi Normal         guifg=#d1cfcf guibg=#040507 gui=NONE
...
hi NonText        guifg=#999999 guibg=#040507 gui=NONE
